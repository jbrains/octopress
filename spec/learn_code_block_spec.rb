...
describe Jekyll::CodeBlock do
  pending "This won't work, because CodeBlock knows too much about the context" do
    context "rendering" do
      example "happy path" do
        text_following_open_tag = <<-REMAINING_TEXT
...
REMAINING_TEXT
        ...
        # Let me guess... the text_following_open_tag needs to be TOKENIZED!
        tag = Jekyll::CodeBlock.new("codeblock", "TestingIoFailure.java https://gist.github.com/jbrains/4111662#file-testingiofailure-java", [text_following_open_tag, " \n"]) # Just keepin' it real at the end, there

        # It looks like @nodelist is empty somehow
        # It looks like I need to tokenize() the thing
        tag.render(Liquid::Context.new).should == ""
      end
    end
  end
end
